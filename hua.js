...
function animate() {
  ...
  // while (current <= outer) {
  //   ctx.arc(center, height / 2, start + current, 0, 2 * Math.PI);
  //   current += 50;
  // }

  ctx.arc(center, height / 2, 300, 0, 2 * Math.PI);
  ctx.stroke();
  ctx.beginPath();
  ctx.arc(center, height / 2, 350, 0, 2 * Math.PI);
  ctx.stroke();
  ctx.beginPath();
  ctx.arc(center, height / 2, 400, 0, 2 * Math.PI);
  ctx.stroke();
